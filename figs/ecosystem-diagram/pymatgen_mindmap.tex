...
\begin{tikzpicture}[
  ...
  child [concept color=Gold, text=black] {
      node {Machine Learning and Computational Methods} [clockwise from=45]
  ...
  child [concept color=Teal, text=black] {
      node {Energy Materials and Devices} [clockwise from=10]
  ...
  child [concept color=Red, text=black] {
      node {Advanced Materials and Nanomaterials} [clockwise from=-60]
  ...
  child [concept color=Purple, text=black] {
      node {Semiconductors, Oxides, and Electronic Materials} [clockwise from=200]
  ...
  child [concept color=DarkGreen, text=black] {
      node {Catalysis and Chemical Processes} [clockwise from=120]
